...
int32_t FunctionServlet::handle(xzmjx::http::HttpRequest::ptr req
...
int32_t NotFoundServlet::handle(xzmjx::http::HttpRequest::ptr req
            ,xzmjx::http::HttpResponse::ptr rsp
            ,xzmjx::http::HttpSession::ptr session){
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("xzmjx/1.0"));
}
int32_t ServletDispatch::handle(xzmjx::http::HttpRequest::ptr req
                ,xzmjx::http::HttpResponse::ptr rsp
                ,xzmjx::http::HttpSession::ptr session){
