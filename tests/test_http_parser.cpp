...
void test_request(const char *str) {
    xzmjx::http::HttpRequestParser parser;
    std::string tmp = str;
    ...
    if (parser.hasError()) {
        ...
        xzmjx::http::HttpRequest::ptr req = parser.getData();
        std::cout << req->toString() << std::endl;
    }
}

void test_response(const char *str) {
    xzmjx::http::HttpResponseParser parser;
    std::string tmp = str;
    ...
    if (parser.hasError()) {
        ...
        xzmjx::http::HttpResponse::ptr rsp = parser.getData();
...
int main(int argc, char *argv[]) {
    ...
    //xzmjx::Config::LoadFromConfDir(sylar::EnvMgr::GetInstance()->getConfigPath());
